...
function ENT:OnSpawn( PObj )
	...
	//FRONT ARMOR
	self:AddArmor( Vector(100,0,40), Angle( 0,0,0 ), Vector(-25,-40,-15), Vector(30,40,40), 1100, self.FrontArmor )

	//LEFT ARMOR
	self:AddArmor( Vector(15,50,55), Angle( 0,0,0 ), Vector(-130,-5,0), Vector(70,5,25), 950, self.SideArmor )

	//RIGHT ARMOR
	self:AddArmor( Vector(15,-50,55), Angle( 0,0,0 ), Vector(-130,-5,0), Vector(70,5,25), 950, self.SideArmor )

	//BACK ARMOR
	self:AddArmor( Vector(-130,0,40), Angle( 0,0,0 ), Vector(-15,-50,-15), Vector(15,50,40), 900, self.BackArmor )


	//TURRET ARMOR
	local TurretArmor = self:AddArmor( Vector(0,0,75), Angle(0,0,0), Vector(-45,-45,0), Vector(55,45,45), 2000, self.TurretArmor )
