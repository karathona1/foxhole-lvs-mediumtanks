...
ENT.PrintName = "SUPER ADMIN TALOS!!!"
ENT.Author = "Kalamari"
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		bullet.Spread 	= Vector(0.003,0.003,0.003)
		...
		if IsValid( PhysObj ) then
			PhysObj:ApplyForceOffset( -bullet.Dir * 140000, bullet.Src )
		end
		...
		ent:EmitSound("vehicles/FieldGunReloadNew.wav", 100, 100, 1, CHAN_WEAPON )
	end
